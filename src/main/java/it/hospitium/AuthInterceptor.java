...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    private Optional<User> getLoggedUser(HttpServletRequest request) {
        Object emailObj = request.getSession().getAttribute("HOSPITIUM_EMAIL");
        Object pswHashObj = request.getSession().getAttribute("HOSPITIUM_PSW_HASH");
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (user.isEmpty()) {
            ...
            //   - /medico/* If the user is a medico
            //   - /patient/* If the user is a patient
            ...
            User.Role pathRole;
            if (request.getServletPath().startsWith("/medico")) {
            ...
            if (user.get().getRole() == pathRole) {
                ...
                response.sendRedirect("view/medico/home");
                return false;
            } else {
                response.sendRedirect("view/patient/home");
                return false;
            }
        }
    }
